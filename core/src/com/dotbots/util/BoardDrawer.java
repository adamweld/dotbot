...
//    float xNew = x * boardSize / board.getSize();
//    xNew += boardOriginX - wallWidth / 2;
//    float yNew = y * boardSize / board.getSize();
//    yNew += boardOriginY - wallWidth / 2;
//
//    if (vertical) {
//      yNew += gridWidth;
//      renderer.rect(xNew, yNew, wallWidth, wallLength);
//    } else {
//      xNew += gridWidth;
//      renderer.rect(xNew, yNew, wallLength, wallWidth);
//    }
  }
}
